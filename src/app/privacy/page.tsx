    ...
    <main className="mx-auto max-w-3xl p-6">
      ...
      <div className="rounded-lg border bg-white p-6 shadow-sm">
        ...
        <p className="mt-3 text-sm text-gray-700">
          ...
          generate tags to power your search.
        </p>
        ...
        <ul className="mt-2 list-disc space-y-2 pl-5 text-sm text-gray-700">
          ...
          <li>
            ...
            confidence scores, and captions generated by a tagging worker.
          </li>
          <li>
        ...
        <p className="mt-2 text-sm text-gray-700">
          ...
          database hosting, object storage, AI model APIs). Images may be sent
          to the AI provider <span className="font-medium">only</span> by our
          background worker for tagging.
        </p>
